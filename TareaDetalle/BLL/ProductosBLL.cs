...
namespace TareaDetalle.BLL
{
    public class ProductosBLL
    {
        ...
        private bool Modificar(Productos producto)
        {
            ...
            try
            {
                _contexto.Database.ExecuteSqlRaw($"Delete FROM TareaDetalle where ProductoId={producto.ProductoId}");
        ...
        public List<Productos> GetList(Expression<Func<Productos, bool>> criterio)
        {
         ...
         public List<ProductosDetalle> GetListDet(Expression<Func<ProductosDetalle, bool>> criterio)
        {
